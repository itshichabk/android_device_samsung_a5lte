...
# Inherit from vendor
$(call inherit-product-if-exists, vendor/samsung/a5lte/a5lte-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    kernel/samsung/a5lte/drivers/staging/prima/firmware_bin/WCNSS_cfg.dat:system/etc/firmware/wlan/prima/WCNSS_cfg.dat
