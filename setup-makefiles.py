...
vendordir = '../../../vendor/samsung/a5lte'
lines = []
...
if not os.path.exists(f'{vendordir}/a5lte-vendor.mk'):
    f = open(f'{vendordir}/a5lte-vendor.mk', "w")
    f.write(copyrightText)
    f.write(f"# This file was generated by {os.getcwd()}/setup-makefiles.py")
    f.write("\n$(call inherit-product, vendor/samsung/a5lte/a5lte-vendor-blobs.mk)")
    f.close()
    print("Generated a5lte-vendor.mk")

f = open(f'{vendordir}/a5lte-vendor-blobs.mk','w')
f.write("LOCAL_PATH := vendor/samsung/a5lte\n\nPRODUCT_COPY_FILES += \\")
...
for line in lines:
    ...
    if lines.index(line) +1 < len(lines):
        f.write(" \\")
print("Generated a5lte-vendor-blobs.mk")
f.close()
